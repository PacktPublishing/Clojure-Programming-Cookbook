(defproject cljc-example "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "cljc-example.quil-demo/on-js-reload"}
               
                :compiler {:main cljc-example.quil-demo
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cljc_example.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/cljc_example.js"
                           :main cljc-example.quil-demo
