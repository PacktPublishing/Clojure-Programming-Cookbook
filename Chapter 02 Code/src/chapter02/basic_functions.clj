...
;;=> {:genre ["Detective fiction" "fantasy" "science fiction" "historical novels" "non-fiction"], :occupation ["novelist" "short story writer" "poet" "physician"], :name "Arthur Ignatius Conan Doyle", :no-of-children 5, :nationality "scottish", :died "7-July-1930", :spouse ["Louisa Hawkins" "Jean Leckie"], :notable-works ["Stories of Sherlock Holmes" "The Lost World"], :citizenship "United Kingdom", :born "22-May-1859"}
...
(into #{} [:a :b :c :d :e])
#{:e :c :b :d :a}
(distinct ["apple" "orange" "melon" "grape" "orange" "pineapple"])
;;=> ("apple" "orange" "melon" "grape" "pineapple")
(into #{} ["apple" "orange" "melon" "grape" "orange" "pineapple"])
;;=> #{"apple" "pineapple" "orange" "grape" "melon"}
